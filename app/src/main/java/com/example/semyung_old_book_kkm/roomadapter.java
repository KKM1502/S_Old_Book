...
public class roomadapter extends RecyclerView.Adapter<roomadapter.ViewHolder> {
    ...
    public interface AdapterCallback {
        void DoSomeThing(String roomname);
    }
    ...
    public roomadapter(ArrayList<String> list0, ArrayList<String> list1, ArrayList<String> list2, ArrayList<String> list3, ArrayList<String> list4, AdapterCallback AdapterCallback, Context context) {
        mDataTitle = list0 ;
            ...
            ll_con.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (mAdapterCallback != null) {
                        ...
                        mAdapterCallback.DoSomeThing(mDataCondition.get(getLayoutPosition()));
                    }
                }
            });
        }
